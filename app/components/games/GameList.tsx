...
export const renderGridItem = (game: GameGroup) => (
  <TouchableOpacity
    key={game.gameId}
    ...
    <View className="rounded-lg overflow-hidden">
      ...
      {game.isPopular && (
        <View
          ...
          <BodyText style={{ color: "white", fontSize: 10 }}>Popular</BodyText>
        </View>
      )}
      <View className="p-2">
        <BodyText
...
export const renderListItem = (game: GameGroup) => (
  <TouchableOpacity key={game.gameId} className="mb-3">
    <View
